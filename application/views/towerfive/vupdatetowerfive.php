      ...
      <div class="row">
        <div class="col-md-6">
           ...
           <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST"  action="<?php echo base_url('towerFive/saveUpdateTowerFive')?>">
                <div class="card-body">
  ...
  $(document).ready(function(){
    ...
    $(".btn-save-edit-address").click(function(){
          ...
          $.ajax({
            ...
            url: "<?= base_url('TowerFive/saveUpdateAddress');?>",
    ...
    $(".btn-save-add-address").click(function(){
          ...
          $.ajax({
            ...
            url: "<?= base_url('TowerFive/saveAddAddress');?>",
            success: function(data){
              window.location.href= data;
            }
          });
    ...
    $(".btn-delete").click(function(){
      ...
      var id = this.id;
      $.ajax({
      url:"<?php echo base_url();?>towerFive/deleteAddress",
      type: "POST",
      data:{
        'id' : id
      },
