...
<div class="content">
    <div class="container-fluid">
        <div class="row">
                <form id="form-insert" method="POST" autocomplete="off" role="form" action="<?php echo base_url('towerfour/addtowerfour')?>">
                ...
                <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <a href="<?php echo base_url('listDefect/'.$rows['lantai'])?>">Add Defect</a>       
                            </div>
                            </div>
