              ...
              <div class="card-body">
                <table id="viewDataTable" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <button type="button" rel="tooltip" title="Remove" data-toggle="modal" data-target="#modalDelete<?php echo $row['id_cta'];?>" class="btn btn-danger btn-simple btn-xs">
                  ...
                  <!-- Modal HTML -->
                  <div id="modalDelete<?php echo $row['id_cta'];?>" class="modal fade">
                    <div class="modal-dialog modal-confirm">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-center">
                          ...
                          <button type="button" class="btn btn-danger"><a href="<?php echo base_url('towerOne/deletetowerone/'.$row['id_cta']);?>">Delete</a></button>
                        </div>
                      </div>
                    </div>
                  </div>     
