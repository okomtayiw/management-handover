...
<div class="content">
    <div class="container-fluid">
        <div class="row">
                <form id="form-insert" method="POST" autocomplete="off" role="form" action="<?php echo base_url('towerone/addtowerone')?>">
                            ...
                            <div class="col-sm-10">
                            <input type="date" id="undangan"  name="nmUndangan1" value="">
                            <small class="text-danger"><?php echo form_error('nmUndangan1'); ?></small> 
                            <input type="date" id="undangan"  name="nmUndangan2" value="">
                            <small class="text-danger"><?php echo form_error('nmUndangan2'); ?></small> 
                            <input type="date" id="undangan"  name="nmUndangan3" value="">
