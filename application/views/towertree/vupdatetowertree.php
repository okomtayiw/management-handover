      ...
      <div class="row">
        <div class="col-md-6">
           ...
           <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST"  action="<?php echo base_url('towerTree/saveUpdateTowerTree')?>">
                <div class="card-body">
                ...
                <input type="hidden" name="idTowerTree" value="<?php echo $rows['id_stc'];?>" />
  ...
  $(document).ready(function(){
    ...
    $(".btn-save-edit-address").click(function(){
          ...
          $.ajax({
            ...
            url: "<?= base_url('TowerTree/saveUpdateAddress');?>",
    ...
    $(".btn-save-add-address").click(function(){
          ...
          $.ajax({
            ...
            url: "<?= base_url('TowerTree/saveAddAddress');?>",
            success: function(data){
              window.location.href= data;
            }
          });
    ...
    $(".btn-delete").click(function(){
      ...
      var id = this.id;
      $.ajax({
      url:"<?php echo base_url();?>TowerTree/deleteAddress",
      type: "POST",
      data:{
        'id' : id
      },
