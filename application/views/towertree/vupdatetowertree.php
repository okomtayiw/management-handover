...
?>
<?= $this->session->flashdata('messageSuksesInsertTowerTree');?>
<div class="content">
    <div class="container-fluid">
        <div class="row">
                <form id="form-insert" method="POST" autocomplete="off" role="form" action="<?php echo base_url('towerTree/saveUpdateTowerTree')?>">
