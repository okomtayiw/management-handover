              ...
              <div class="card-body">
                <table id="viewDataTable" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <a href="<?php echo base_url('TowerTwo/updateTowerTwo/'.$row['id_stc']);?>"><i class="fa fa-edit"></i></a>
                    </button>
                    ...
                    <div class="modal-dialog modal-confirm">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-center">
                          ...
                          <button type="button" class="btn btn-danger"><a href="<?php echo base_url('TowerTwo/deleteTowerTwo/'.$row['id_stc']);?>">Delete</a></button>
                        </div>
                      </div>
                    </div>
                  </div>     
