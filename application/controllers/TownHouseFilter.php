...
class TownHouseFilter extends CI_Controller {
    ...
    public function index(){
        ...
        $totDataTownhouse = $this->TownHouseModel->totDataTownHouseFilter($filter);
        ...
        $config['attributes'] = array('class' => 'page-link');
            ...
            if ($countData == 0){
                ...
                $limit_per_page = $totDataTownhouse;
            }
            ...
            $data ['title'] = 'Halaman Data Tower D Filter';
            $data ['townhouse'] = $this->TownHouseModel->get_current_page_records_twhFilter($limit_per_page, $data['start'], $filter);
            
            $config['base_url'] = base_url().'townHouseFilter/'.$filter.'/page';
            ...
            $this->load->view('datafilter/townhouseview', $data);
