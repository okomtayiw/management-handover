...
class TowerTreeFilter extends CI_Controller {
    ...
    public function index(){
        ...
        $totDataTowerc = $this->TowerTreeModel->totDataTowerTreeFilter($filter);
        ...
        $config['attributes'] = array('class' => 'page-link');
            ...
            $data ['towertree'] = $this->TowerTreeModel->get_current_page_records_twcFilter($limit_per_page, $data['start'], $filter);
            
            $config['base_url'] = base_url().'towerTreeFilter/'.$filter.'/page';
            $config['total_rows'] = $totDataTowerc;
            ...
            $this->load->view('datafilter/towertreeview', $data);
