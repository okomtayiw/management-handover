...
class TowerOneFilter extends CI_Controller {
    ...
    public function index(){
        ...
        $totDataTowera = $this->TowerOneModel->totDataTowerOneFilter($filter);
        ...
        $config['attributes'] = array('class' => 'page-link');
            ...
            $data ['title'] = 'Halaman Data Tower A Filter';
            $data ['towerone'] = $this->TowerOneModel->get_current_page_records_twaFilter($limit_per_page, $data['start'], $filter);
            
            $config['base_url'] = base_url().'towerOneFilter/'.$filter.'/page';
            ...
            $this->load->view('datafilter/toweroneview', $data);
