...
Class TowerFourModel extends CI_Model{
  ...
  public function getAllDataTowerFourUpdate($idTowerFour){
    ...
    public function get_current_page_records_twd() 
    {
        ...
        $query = $this->db->query("SELECT tbl_std.* FROM tbl_std
        ORDER BY tbl_std.id_std ");
        return $query->result_array();  
    }
    ...
    public function get_current_page_records_twdFilter($limit, $start, $filter) 
    {
        if ($filter == 'HO') {

          $query = $this->db->query("SELECT tbl_std.*,tbl_defect.name_defect as nameDefect, status.status as nameStatus,tbl_status_unit.nama_status_unit as statusUnit FROM tbl_std
          LEFT OUTER JOIN status ON tbl_std.status = status.id_status 
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.status = 1
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.status_unit_barter = 'barter'
          ORDER BY tbl_std.pemilik ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.status_unit_barter = 'barter' AND tbl_std.status = 1
          ORDER BY tbl_std.pemilik ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.status_unit_barter = 'barter' AND tbl_std.status = ''
          ORDER BY tbl_std.pemilik ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.ready_ho = 'Sudah siap serah terima' AND tbl_std.status = '' AND tbl_std.status_unit_barter != 'barter'
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.undangan != '0000-00-00' AND tbl_std.status != 1  AND tbl_std.ready_ho !=''
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.undangan2 != '0000-00-00' AND tbl_std.status != 1  AND tbl_std.ready_ho !=''
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.undangan3 != '0000-00-00' AND tbl_std.status != 1  AND tbl_std.ready_ho !=''
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
        }  else if ($filter == 'sto') {
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.tgl_sts != '0000-00-00' AND tbl_std.status != 1  
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.date_openQC  != '0000-00-00' AND tbl_std.status != 1   
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.date_closeQC  != '0000-00-00' AND tbl_std.status != 1   
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.status = '' AND tbl_std.penerimaan BETWEEN '5' AND '100'
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
          ...
          LEFT OUTER JOIN tbl_status_unit  ON tbl_std.id_status_unit = tbl_status_unit.id_status_unit 
          LEFT OUTER JOIN tbl_defect ON tbl_std.id_defect = tbl_defect.id_defect
          WHERE tbl_std.ready_ho != '' AND tbl_std.status = ''  AND tbl_std.penerimaan BETWEEN '0' AND '4' 
          ORDER BY tbl_std.id_std ASC LIMIT $start, $limit");
        }
    ...
    function totDataTowerdFilter($filter){

      if ($filter == 'HO') {
        $query = $this->db->where('status', 1)->get('tbl_std');
        } else if ($filter == 'NOHO') {
          $query = $this->db->where('status', '')->get('tbl_std');
        } else if ($filter == 'barter') {
          $query = $this->db->where('status_unit_barter', 'barter')->get('tbl_std');
        } else if ($filter == 'readyho') {
          $where  = "ready_ho = 'Sudah siap serah terima' AND status = '' AND status_unit_barter != 'barter'";
          $query = $this->db->where($where)->get('tbl_std');
        } else if ($filter == 'barterho') {
