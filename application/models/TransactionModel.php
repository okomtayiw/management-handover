...
Class TransactionModel extends CI_Model{
  ...
  public function getDataTransaction($idTransaction){
    $query = $this->db->query("SELECT substring(b.lantai,3,1) as tower,a.id_transaction,a.number_trans, a.tgl_hand_over, a.status, b.lantai, b.pemilik, c.id_transaction_detail, c.tiar_tenant, c.no_kwh_listrik, c.start_kwh_listrik,c.no_kwh_air,c.start_kwh_air,c.tot_defect,c.status_defect FROM tbl_transaction as a
    LEFT OUTER JOIN tbl_cta b ON a.id_unit = b.lantai
    ...
    UNION
    SELECT substring(b.lantai,3,1) as tower,a.id_transaction,a.number_trans, a.tgl_hand_over, a.status, b.lantai, b.pemilik, c.id_transaction_detail, c.tiar_tenant, c.no_kwh_listrik, c.start_kwh_listrik,c.no_kwh_air,c.start_kwh_air,c.tot_defect,c.status_defect FROM tbl_transaction as a
    LEFT OUTER JOIN tbl_ctb b ON a.id_unit = b.lantai
    LEFT OUTER JOIN tbl_transaction_detail c ON a.id_transaction = c.id_transaction
    WHERE  b.lantai = a.id_unit AND a.id_transaction = '$idTransaction'
    UNION
